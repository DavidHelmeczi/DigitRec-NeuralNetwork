# This software can recognize hand-drawn digits using a complex convolutional neural network (training script is "trainNN.py". Several steps of pre-processing ensure high-precision predictions
